...
function NecrosisSpellActivationOverlayOptionsPanel_Init(self)
    ...
    -- TBC uses the same warlock proc textures as Era (nightfall/backlash)
local testTextureLeftRight = (SAO.IsEra() or SAO.IsTBC()) and "nightfall" or "nightfall";
local testTextureTop       = (SAO.IsEra() or SAO.IsTBC()) and "backlash"  or "backlash";
