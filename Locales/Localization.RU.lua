...
L["SPELLSTONE_TEXT_2"] = "В сумке - [Левый Клик] Экипировать"
L["SPELLSTONE_TEXT_3"] = "Экипировано - [Левый Клик] Использовать"
L["SPELLSTONE_TEXT_4"] = "Нанесено на оружие\n[Клик] Для замены/обновления"
L["FIRESTONE_TEXT_1"] = "[Правый Клик] Создать камень"
L["FIRESTONE_TEXT_2"] = "В сумке - [Левый Клик] Экипировать"
L["FIRESTONE_TEXT_3"] = "Экипировано"
L["FIRESTONE_TEXT_4"] = "Нанесено на оружие\n[Клик] Для замены/обновления"
...
L["BUFF_MENU_TEXT_3"] = "[Левый Клик] Для закрытия меню"
...
L["PET_MENU_TEXT_3"] = "[Левый Клик] Для закрытия меню"
...
L["CURSE_MENU_TEXT_3"] = "[Левый Клик] Для закрытия меню"
...
L["SPHERE_SPELL"]  = "Заклинание сферы (левый клик)"
L["SPHERE_SPELL2"] = "Заклинание сферы (правый клик)"
L["SPHERE_SPELL_LEFTCLICK"] = "Левый клик — применить"
L["SPHERE_SPELL_RIGHTCLICK"] = "Правый клик — применить"
L["SPHERE_SPELL_MIDDLECLICK"] = "Средний клик — переместить"
L["SPHERE_SPELL_CTRLLEFTCLICK"] = "Ctrl+левый клик — открыть меню настроек"
...
L["MISC_HIDDEN"] = "Показать скрытые кнопки (перетаскивание средней кнопкой мыши)"
