...
L["SPHERE_SPELL"]  = "由球體施放的法術（左鍵點擊）"
L["SPHERE_SPELL2"] = "由球體施放的法術（右鍵點擊）"
L["SPHERE_SPELL_LEFTCLICK"] = "左鍵點擊施放"
L["SPHERE_SPELL_RIGHTCLICK"] = "右鍵點擊施放"
L["SPHERE_SPELL_MIDDLECLICK"] = "中鍵點擊拖曳"
L["SPHERE_SPELL_CTRLLEFTCLICK"] = "Ctrl+左鍵點擊開啟設定選單"
